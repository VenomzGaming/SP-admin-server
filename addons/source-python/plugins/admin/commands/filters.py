'''
	...
	Registering all filters available,
	used for declaring targets.
...
''' Retrieve given players from declared string. '''

from filters.players import PlayerIter
from players.entity import Player

## Custom library used for very clean name comparisons.
